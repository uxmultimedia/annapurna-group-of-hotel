...
const fieldClass = "mt-2 h-13 w-full rounded-[14px] border border-[#173c2b]/12 bg-white px-4 text-[13px] text-[#283c32] outline-none transition focus:border-[var(--emerald)]";
